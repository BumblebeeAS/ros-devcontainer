...
# sudo docker build --ssh default=${SSH_AUTH_SOCK} simulators/simulator-uuv/ -f simulators/simulator-uuv/Dockerfile.base -t ngxingyu/simulator_uuv_base:latest
...
# sudo docker build --ssh default=${SSH_AUTH_SOCK} simulators/simulator-vrx/ -f simulators/simul/ator-vrx/Dockerfile.base -t ngxingyu/simulator_vrx_base:latest
...
# sudo docker build --ssh default=${SSH_AUTH_SOCK} simulators/simulator-vrx-gazebosim/ -f simulators/simulator-vrx-gazebosim/Dockerfile.base -t ngxingyu/simulator_vrx_gazebosim_base:latest
# sudo docker build --ssh default=${SSH_AUTH_SOCK} simulators/simulator-vrx-gazebosim/ -f simulators/simulator-vrx-gazebosim/Dockerfile -t ngxingyu/simulator_vrx_gazebosim:latest  